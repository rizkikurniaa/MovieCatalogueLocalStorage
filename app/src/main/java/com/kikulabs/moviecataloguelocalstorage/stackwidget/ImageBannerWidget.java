...
public class ImageBannerWidget extends AppWidgetProvider {
    private static final String TOAST_ACTION = "com.kikulabs.moviecataloguelocalstorage.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.kikulabs.moviecataloguelocalstorage.EXTRA_ITEM";
